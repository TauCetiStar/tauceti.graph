 ...
 */
public class ScriptDeclarationSerializer implements SVGExtensionAttributeSerializer {

	protected static ScriptDeclarationSerializer INSTANCE = new ScriptDeclarationSerializer();

	public static ScriptDeclarationSerializer getInstance() {
		return INSTANCE;
	}

	public ScriptDeclarationSerializer() {
	}
	...
	public void marshall(Figure shape, Element shapeElement, SVGExtensionAttribute extensionAttribute, SVGExtensionRegistry registry, SVGDOMWriter svgWriter) {
		if (extensionAttribute instanceof ScriptDeclaration) {
			ScriptDeclaration scriptDeclaration = (ScriptDeclaration) extensionAttribute;
